#ifndef SKILL_COLUMN_FORM_HPP
#define SKILL_COLUMN_FORM_HPP
...
class SkillColumnForm : public wxDialog
{
public:
    SkillColumnForm(wxWindow* parent, ConfigurationManager* _configuration);
